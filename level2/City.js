/**
 * Represents a city. Cities can be "linked" together, meaning that you can reach one city from the other.
 * This is always a symmetric relation,
 * meaning that if you can reach city X from Y, then you can also reach Y from X.
 */
...
class City {
  ...
  link (city) {
    this.linkedCities.push(city)
    city.linkedCities.push(this)
  }

  isLinked (city) {
    if(this.linkedCities.includes(city)) {
      console.log(city.linkedCities)
      return true
    }
    return false
  }
...
newYork.link(Amsterdam)
console.log(newYork, Amsterdam)


describe('newCity', function() {
